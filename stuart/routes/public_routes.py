...
from stuart.extensions import login_manager
from stuart.forms.login_form import LoginForm
from stuart.forms.register_form import RegisterForm
from stuart.models.user import User
from stuart.utils import flash_errors
